...
class client implements ActionListener{
    ...
    client(){
        ...
        ImageIcon i1 =  new ImageIcon(ClassLoader.getSystemResource("icons/dp1.png"));
        Image i2 = i1.getImage().getScaledInstance(60, 60 , Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l1 = new JLabel(i3);
        l1.setBounds(15, 2, 60, 60);
        p1.add(l1);
        ...
        JLabel l5 = new JLabel("Joey");
        l5.setFont(new Font("SAN_SERIF", Font.BOLD, 14));
        l5.setForeground(Color.WHITE);
        l5.setBounds(75, 20, 50, 20);
        p1.add(l5);
        ...
        t1.setBackground(new Color(33, 33, 33));
